...
//        "帮助系统",
	...
	public Data() {
		...
		mapUser.put("权限明细树", "RegDialog_cardPanel_funcSelector_tar");
		...
		mapUser.put("授权用户树", "RegDialog_cardPanel_orgSelector_targetList");
		//构造一个临时驱动
		pageREQ = new GWCtrlMainPage("功能授权");
		pageREQ.MODULE_WAIT_ID = "btnAddOptRule";
	}
}
