...
public class Data {
	...
	public Data() {
		...
		//构造一个临时驱动
		pageREQ = new GWCtrlMainPage("商品混凝土调拨结算单");
		//顶层菜单
        ...
        pageREQ.mapDynamicData.put("商品混凝土调拨结算单-收料单位", GScene.DYNAMIC_DATA.get("商品混凝土调拨结算单-收料单位"));
        ...
        pageREQ.mapDynamicData.put("商品混凝土调拨结算单-单据编号", "");
	}
}
