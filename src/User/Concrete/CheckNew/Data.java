...
public class Data {
	...
	public Data() {
		...
		//构造一个临时驱动
		pageREQ = new GWCtrlMainPage("商品混凝土对账单");
		//顶层菜单
		...
		pageREQ.mapTopTabId.put("单据明细", "detialTabView__detialTabView_DJMX");
		...
		//单据菜单
		pageREQ.mapTopTabId.put("选择单据", "btnXZDJ");
		...
		pageREQ.mapDynamicData.put("商品混凝土对账单-单据编号", "");
	}
}
