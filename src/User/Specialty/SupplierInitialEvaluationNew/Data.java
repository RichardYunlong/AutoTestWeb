...
public class Data {
	...
	public Data() {
		...
		//构造一个临时驱动
		pageREQ = new GWCtrlMainPage("专业分包商初评");
		//顶层菜单
	    ...
	    pageREQ.mapContentId.put("联系人姓名", "Efd_LXR");
		...
		//动态参数
		pageREQ.mapDynamicData.put("专业分包商初评-单据编号", "");
		pageREQ.mapDynamicData.put("专业分包商初评-供应商编码", "");
		pageREQ.mapDynamicData.put("专业分包商初评-供应商名称", "");
	    pageREQ.mapDynamicData.put("专业分包商初评-队长姓名", "");
