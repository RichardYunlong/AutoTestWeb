...
public class Data {
	...
	public Data() {
		...
		//构造一个临时驱动
		pageREQ = new GWCtrlMainPage("专业分包商评价");
		//顶层菜单
		...
		pageREQ.mapContentId.put("企业编码", "fd_PartnerList_Code");
		pageREQ.mapContentId.put("企业名称", "fd_PartnerList_Name");
		...
		//动态参数
		pageREQ.mapDynamicData.put("专业分包商评价-单据编号", "");
		pageREQ.mapDynamicData.put("专业分包商评价-企业编码", "");
		pageREQ.mapDynamicData.put("专业分包商评价-企业名称", "");
		pageREQ.mapDynamicData.put("专业分包商类别-类别编码", GScene.DYNAMIC_DATA.get("专业分包商类别-类别编码"));
        pageREQ.mapDynamicData.put("专业分包商名录-企业编码", GScene.DYNAMIC_DATA.get("专业分包商名录-企业编码"));
