...
public class Data {
	...
	public Data() {
	    ...
	    pageREQ.mapTopTabId.put("参考其他单位调入", "x-menu-el-btnRefQTDWDY");
		...
		pageREQ.mapContentId.put("入库数量", "gvCLMX_col_SL_editor");
		...
		strDate = "2020-04-09";
		//动态数据
		pageREQ.mapDynamicData.put("材料入库单-供应商", GScene.DYNAMIC_DATA.get("材料入库单-供应商"));
		pageREQ.mapDynamicData.put("材料入库单-材料编码", GScene.DYNAMIC_DATA.get("材料入库单-材料编码"));
		pageREQ.mapDynamicData.put("材料入库单-材料明细-含税单价", GScene.DYNAMIC_DATA.get("材料入库单-材料明细-含税单价"));
		pageREQ.mapDynamicData.put("材料入库单-材料明细-数量", GScene.DYNAMIC_DATA.get("材料入库单-材料明细-数量"));
		pageREQ.mapDynamicData.put("材料入库单-材料明细-税率(%)", GScene.DYNAMIC_DATA.get("材料入库单-材料明细-税率(%)"));
		pageREQ.mapDynamicData.put("材料需用计划-单据编号", GScene.DYNAMIC_DATA.get("材料需用计划-单据编号"));
	    pageREQ.mapDynamicData.put("参考单据编号", GScene.DYNAMIC_DATA.get("参考单据编号"));
		pageREQ.mapDynamicData.put("材料入库单-单据编号", "");
	}
}
