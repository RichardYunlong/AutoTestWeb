...
public class Data {
	...
	public Data() {
		...
		pageREQ.mapTopTabId.put("材料明细", "detialTabView__detialTabView_CLMX");
		...
		//材料明细
		pageREQ.mapContentId.put("部位名称", "gvCLMX_col_BWMC_editor");
		pageREQ.mapContentId.put("计划数量", "gvCLMX_col_SL_editor");
		//等待标签
		pageREQ.MODULE_WAIT_ID = GWCtrlWebElementId.CN_ID.get("材料明细");
		//日期
		strDate = "2020-04-09";
		//动态参数
		pageREQ.mapDynamicData.put("材料部位计划-材料类型编码", GScene.DYNAMIC_DATA.get("材料部位计划-材料类型编码"));
		pageREQ.mapDynamicData.put("材料部位计划-材料编码", GScene.DYNAMIC_DATA.get("材料部位计划-材料编码"));
		pageREQ.mapDynamicData.put("材料部位计划-计划数量", GScene.DYNAMIC_DATA.get("材料部位计划-计划数量"));
		pageREQ.mapDynamicData.put("材料部位计划-部位名称", GScene.DYNAMIC_DATA.get("材料部位计划-部位名称"));
		pageREQ.mapDynamicData.put("材料部位计划-单据编号", "");
	}
}
