...
public class Data {
	...
	public Data() {
		...
		pageREQ.mapTopTabId.put("材料明细", "detialTabView__name_1998849891");
		...
		//基本信息
		pageREQ.mapContentId.put("调出单位", "Efd_DCDW_Name");
		pageREQ.mapContentId.put("合同编号", "Efd_HT_Code");
		pageREQ.mapContentId.put("合同名称", "Efd_HT_Name");
		pageREQ.mapContentId.put("调入单位", "Efd_DRDW_Name");
		pageREQ.mapContentId.put("备注", "Efd_evRemark_Remark");
		//材料明细
		pageREQ.mapContentId.put("调拨数量", "gvCLMX_col_DBSL_editor");
		//等待标签
		...
		//动态参数
		pageREQ.mapDynamicData.put("租赁周转材料内部调拨单-单据编号", "");
		pageREQ.mapDynamicData.put("租赁周转材料内部调拨单-调入单位", GScene.DYNAMIC_DATA.get("租赁周转材料内部调拨单-调入单位"));
		pageREQ.mapDynamicData.put("租赁周转材料内部调拨单-调出单位", GScene.DYNAMIC_DATA.get("租赁周转材料内部调拨单-调出单位"));
		pageREQ.mapDynamicData.put("租赁周转材料内部调拨单-材料类型编码", GScene.DYNAMIC_DATA.get("租赁周转材料内部调拨单-材料类型编码"));
		pageREQ.mapDynamicData.put("租赁周转材料内部调拨单-材料编码", GScene.DYNAMIC_DATA.get("租赁周转材料内部调拨单-材料编码"));
		pageREQ.mapDynamicData.put("租赁周转材料内部调拨单-调拨数量", GScene.DYNAMIC_DATA.get("租赁周转材料内部调拨单-调拨数量"));
