...
public class Data {
    ...
    */
	...
	public Data() {
		...
		pageREQ.mapContentId.put("退货日期", "Efd_BizDate");
		...
		pageREQ.mapContentId.put("退货原因", "Efd_THYY");
		pageREQ.mapContentId.put("备注", "Efd_evRemark_Remark");
		//材料明细
		pageREQ.mapContentId.put("退货含税单价", "gvCLMX_col_HSDJ_editor");
		pageREQ.mapContentId.put("退货数量", "gvCLMX_col_SL_editor");
		...
		strDate = "2020-04-09";
		//动态数据
		pageREQ.mapDynamicData.put("材料退货单-供应商", GScene.DYNAMIC_DATA.get("材料退货单-供应商"));
		pageREQ.mapDynamicData.put("材料退货单-材料编码", GScene.DYNAMIC_DATA.get("材料退货单-材料编码"));
		pageREQ.mapDynamicData.put("材料退货单-材料明细-含税单价", GScene.DYNAMIC_DATA.get("材料退货单-材料明细-含税单价"));
		pageREQ.mapDynamicData.put("材料退货单-材料明细-数量", GScene.DYNAMIC_DATA.get("材料退货单-材料明细-数量"));
		pageREQ.mapDynamicData.put("材料退货单-材料明细-税率(%)", GScene.DYNAMIC_DATA.get("材料退货单-材料明细-税率(%)"));
		pageREQ.mapDynamicData.put("材料入库单-单据编号", GScene.DYNAMIC_DATA.get("材料入库单-单据编号"));
		pageREQ.mapDynamicData.put("材料退货单-单据编号", "");
	}
}
