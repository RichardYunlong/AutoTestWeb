...
public class Data {
	...
	public Data() {
		...
		//构造一个临时驱动
		pageREQ = new GWCtrlMainPage("材料总量计划");
		//顶层菜单
		...
		strDate = "2020-04-09";
		//动态参数
		pageREQ.mapDynamicData.put("材料总量计划-材料类型编码", GScene.DYNAMIC_DATA.get("材料总量计划-材料类型编码"));
		pageREQ.mapDynamicData.put("材料总量计划-材料编码", GScene.DYNAMIC_DATA.get("材料总量计划-材料编码"));
		pageREQ.mapDynamicData.put("材料总量计划-计划数量", GScene.DYNAMIC_DATA.get("材料总量计划-计划数量"));
		pageREQ.mapDynamicData.put("材料总量计划-单据编号", "");
	}
}
