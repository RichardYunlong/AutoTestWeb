...
public class Data {
	...
	public Data() {
		...
		//构造一个临时驱动
		pageREQ = new GWCtrlMainPage("物资供应商评价");
		//顶层菜单
		...
		pageREQ.mapContentId.put("供应商编码", "fd_PartnerList_Code");
		pageREQ.mapContentId.put("供应商名称", "fd_PartnerList_Name");
		...
		//动态参数
		pageREQ.mapDynamicData.put("物资供应商评价-单据编号", "");
		pageREQ.mapDynamicData.put("物资供应商评价-供应商编码", "00002-WZGYSML-202004-0002");
		pageREQ.mapDynamicData.put("物资供应商评价-供应商名称", "自动化1供应商");
	}
}
