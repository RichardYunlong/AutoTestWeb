...
public class Data {
	...
	public Data() {
		...
		pageREQ.mapTopTabId.put("材料明细", "detialTabView__detialTabView_CLMX");//与开发已确认此ID唯一
		...
		//单据菜单
		pageREQ.mapTopTabId.put("参考需用计划", "btnReferXYJH");
		//基本信息
		pageREQ.mapContentId.put("计划日期", "Efd_BizDate");
		pageREQ.mapContentId.put("备注", "Efd_evRemark_Remark");
		//材料明细
		pageREQ.mapContentId.put("计划单价", "gvCLMX_col_JHDJ_editor");
		pageREQ.mapContentId.put("本次计划量", "gvCLMX_col_SL_editor");
		//等待标签
		pageREQ.MODULE_WAIT_ID = GWCtrlWebElementId.CN_ID.get("材料明细");
		//日期
		strDate = "2020-04-09";
		//动态参数
		pageREQ.mapDynamicData.put("材料采购计划-材料类型编码", GScene.DYNAMIC_DATA.get("材料采购计划-材料类型编码"));
		pageREQ.mapDynamicData.put("材料采购计划-材料编码", GScene.DYNAMIC_DATA.get("材料采购计划-材料编码"));
		pageREQ.mapDynamicData.put("材料采购计划-材料明细-计划单价", GScene.DYNAMIC_DATA.get("材料采购计划-材料明细-计划单价"));
		pageREQ.mapDynamicData.put("材料采购计划-材料明细-本次计划量", GScene.DYNAMIC_DATA.get("材料采购计划-材料明细-本次计划量"));
		pageREQ.mapDynamicData.put("材料采购计划-单据编号", "");
