...
public class Data {
	...
	public Data() {
		...
		//构造一个临时驱动
		pageREQ = new GWCtrlMainPage("材料到货点验单");
		//顶层菜单
		...
		pageREQ.mapTopTabId.put("材料明细", "detialTabView__name_428061022");
		...
		pageREQ.mapContentId.put("到货日期", "Efd_JYRQ");
		pageREQ.mapContentId.put("验收人", "Efd_JYR");
		...
		//材料明细
		pageREQ.mapContentId.put("单价", "gvDHDYDCLMX_col_DJ_editor");
		pageREQ.mapContentId.put("到货量", "gvDHDYDCLMX_col_DHL_editor");
		//等待标签
		pageREQ.MODULE_WAIT_ID = GWCtrlWebElementId.CN_ID.get("材料到货点验单-材料明细");
		//日期
		strDate = "2020-04-09";
		//动态参数
		pageREQ.mapDynamicData.put("材料采购合同-单据编号", GScene.DYNAMIC_DATA.get("材料采购合同-单据编号"));
		pageREQ.mapDynamicData.put("材料需用计划-单据编号", GScene.DYNAMIC_DATA.get("材料需用计划-单据编号"));
		pageREQ.mapDynamicData.put("材料到货点验单-到货材料-单价", GScene.DYNAMIC_DATA.get("材料到货点验单-到货材料-单价"));
		pageREQ.mapDynamicData.put("材料到货点验单-到货材料-到货量", GScene.DYNAMIC_DATA.get("材料到货点验单-到货材料-到货量"));
		pageREQ.mapDynamicData.put("材料采购合同-材料明细-数量", GScene.DYNAMIC_DATA.get("材料采购合同-材料明细-数量"));
		pageREQ.mapDynamicData.put("材料到货点验单-单据编号", "");
	}
}
