...
public class Data {
	...
	public Data() {
		...
		//构造一个临时驱动
		pageREQ = new GWCtrlMainPage("材料采购合同");
		//顶层菜单
		...
		pageREQ.mapTopTabId.put("材料明细", "detialTabView__detialTabView_tabClcghtClmx");
		...
		//材料明细
		pageREQ.mapContentId.put("含税单价", "gvCLMX_col_ZDJ_editor");
		pageREQ.mapContentId.put("数量", "gvCLMX_col_ZSL_editor");
		...
		strDate = "2020-04-09";
		//动态参数
		pageREQ.mapDynamicData.put("材料采购合同-甲方", GScene.DYNAMIC_DATA.get("材料采购合同-甲方"));
		pageREQ.mapDynamicData.put("材料采购合同-乙方", GScene.DYNAMIC_DATA.get("材料采购合同-乙方"));
		pageREQ.mapDynamicData.put("材料采购合同-材料明细-含税单价", GScene.DYNAMIC_DATA.get("材料采购合同-材料明细-含税单价"));
		pageREQ.mapDynamicData.put("材料采购合同-材料明细-数量", GScene.DYNAMIC_DATA.get("材料采购合同-材料明细-数量"));
		pageREQ.mapDynamicData.put("材料采购合同-材料明细-税率(%)", GScene.DYNAMIC_DATA.get("材料采购合同-材料明细-税率(%)"));
		pageREQ.mapDynamicData.put("材料需用计划-单据编号", GScene.DYNAMIC_DATA.get("材料需用计划-单据编号"));
		pageREQ.mapDynamicData.put("材料采购合同-单据编号", "");
		pageREQ.mapDynamicData.put("材料采购合同-合同名称", "");
	}
}
