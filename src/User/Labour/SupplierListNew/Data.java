...
public class Data {
	...
	public Data() {
		...
		//构造一个临时驱动
		pageREQ = new GWCtrlMainPage("劳务分包商名录");
		//顶层菜单
		...
		//基本信息
		pageREQ.mapContentId.put("分包商编码", "Efd_Code");
		pageREQ.mapContentId.put("企业名称", "Efd_Name");
		...
		//动态参数
		pageREQ.mapDynamicData.put("劳务分包商名录-分包商编码", "");
		pageREQ.mapDynamicData.put("劳务分包商名录-企业名称", "");
	}
}
