...
public class Data {
	...
	public Data() {
		...
		//构造一个临时驱动
		pageREQ = new GWCtrlMainPage("劳务分包商评价");
		//顶层菜单
		...
		//动态参数
		pageREQ.mapDynamicData.put("劳务分包商评价-单据编号", "");
		pageREQ.mapDynamicData.put("劳务分包商评价-分包商编码", "");
		pageREQ.mapDynamicData.put("劳务分包商评价-分包商名称", "");
